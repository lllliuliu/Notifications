-- ----------------------------
-- Table structure for user_notification_broadcast
-- ----------------------------
DROP TABLE IF EXISTS `user_notification_broadcast`;
CREATE TABLE `user_notification_broadcast` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户广播消息表';

-- ----------------------------
-- Table structure for user_notification_categories
-- ----------------------------
DROP TABLE IF EXISTS `user_notification_categories`;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户系统消息表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户消息表';
